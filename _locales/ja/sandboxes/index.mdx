...
- **Boot from a template** — 各ノードはテンプレートごとに golden snapshot を事前構築するため、`create` はコールドブートではなく復元です。
...
| **Dashboard** | 手動作成、ターミナル、SSH、モニタリング | [Dashboard](/sandboxes/dashboard) |
