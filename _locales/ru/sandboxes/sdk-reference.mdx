...
| `volumeName` | string | — | Подключить [том](/sandboxes/volumes) по имени в `/workspace` |
...
Подробности — в [Persistent Volumes](/sandboxes/volumes). Имена уникальны в проекте: строчные латинские буквы, цифры и дефисы, до 64 символов.
