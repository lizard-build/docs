...
Consulta [Tiempo de compilación vs. tiempo de ejecución](/variables#build-time-vs-runtime) y [Proceso de compilación → qué activa una recompilación](/concepts/build-pipeline#what-triggers-a-rebuild).
