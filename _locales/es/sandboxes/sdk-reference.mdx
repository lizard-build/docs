---
description: "Todas las clases y métodos del Lizard SDK para JavaScript y Python: Lizard, Sandbox, CodeSandbox y Volume, con opciones y tipos de retorno."
---
...
Amplía `Sandbox` con un kernel con estado. Consulta [Code Interpreter](/sandboxes/code-interpreter) para ver el recorrido completo.
...
- [Code Interpreter](/sandboxes/code-interpreter): la guía de `CodeSandbox`.
