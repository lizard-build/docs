---
description: "lizard up empaqueta el directorio actual, lo compila en los nodos de compilación de Lizard y devuelve una URL activa. Flags, comportamiento en CI y ejemplos."
---
...
- [Deploy from local code](/deploy/upload) — guía completa de los despliegues basados en subida
...
- [Deploy a container without configuring one](https://lizard.build/blog/container-as-a-service#deploy-a-container-without-configuring-one) — dónde se ubica este comando entre las plataformas de contenedor como servicio
