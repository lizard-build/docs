...
Esto siempre refleja tu versión instalada; es preferible a adivinar la forma de las banderas. También es como un agente aprende la CLI sin haber sido entrenado con ella: consulta [deploying from Claude Code](https://lizard.build/blog/deploy-from-claude-code).
