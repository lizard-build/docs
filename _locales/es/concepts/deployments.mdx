...
1. **Compilación** — la plataforma ejecuta tu compilación (consulta [Build Pipeline](/concepts/build-pipeline)).
...
En el [panel](/dashboard), la vista de **Deployments** muestra la cronología completa, los registros de compilación de cada despliegue y un panel de detalles para cada publicación.
