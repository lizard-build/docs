...
Siehe [framework test results](/framework-guides/validation) für den separaten Framework-Batch mit 16 Rezepten und [known issues](/platform/known-issues) für CLI-Archiv- und Exit-Code-Einschränkungen bei fehlgeschlagenen Builds.
