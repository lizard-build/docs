...
Jedes Add-on stellt einen festen Satz an Umgebungsvariablen bereit, den Ihre Services per **Referenz** verwenden (`${{<addon-name>.KEY}}`). Siehe [Managed Addons](/addons).
