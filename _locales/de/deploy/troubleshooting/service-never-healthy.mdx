---
description: "Ein Build ist erfolgreich, aber der Deploy bleibt ungesund. Port-Binding, versehentlicher Worker-Modus und weitere Ursachen für einen fehlschlagenden Health-Check."
---
...
- [Deployments → lifecycle](/concepts/deployments#lifecycle) — wo der Health-Check innerhalb eines Deploys stattfindet.
