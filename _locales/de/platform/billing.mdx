...
Lesen Sie vor dem Entfernen von Daten [storage and recovery](/platform/storage-and-recovery). Lesen Sie [metrics](/observability/metrics), um konfigurierte Limits mit der gemessenen Nutzung zu vergleichen.
