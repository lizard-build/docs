...
Wenn Formulare einen Fehler wegen einer Cross-Site-Übermittlung melden, prüfe `ORIGIN`, bevor du eine Sicherheitsprüfung deaktivierst. Wenn `node build` den Server nicht finden kann, prüfe den aktiven Adapter und den Ausgabepfad. Lasse Überschreibungen des Service-Befehls ungesetzt, um den lizardpack-Pfad zu verwenden.
...
Für eine Site, deren Routen vollständig generiert werden können, füge dies zu `src/routes/+layout.js` hinzu:
