...
Each replica is its own pod. Make sure your app is stateless (store state in [Postgres](/addons/postgres), [Redis](/addons/redis), or [S3](/addons/storage)) so replicas are interchangeable.
