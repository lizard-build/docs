---
description: "Add replicas or raise CPU and memory for a service, and grow addon storage. Allowed ranges, rollout behavior, and how to verify a change."
---
...
- [`lizard scale`](/cli/scale) — the full command reference.
