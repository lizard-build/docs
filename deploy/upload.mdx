---
description: "Ship the current directory with lizard up, no Git required. Covers gitignore handling, build and start overrides, and headless CI use."
---
...
- [`lizard up`](/cli/up) — the full command reference.
