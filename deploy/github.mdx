---
description: "Connect a GitHub repo so every push to the tracked branch builds and redeploys, including private repos, branch switching, and monorepos."
---
...
- [`lizard git`](/cli/git) — the full command reference for `connect`, `status`, and `checkout`.
