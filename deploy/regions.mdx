---
description: "Pick where your services and addons run, co-locate stateful resources to cut latency, and see how region affects generated domains."
---
...
Each service gets a generated domain on `*.onlizard.com` with automatic TLS, regardless of region. Object storage served from an [S3 addon](/addons/storage) uses a region-scoped gateway host (`s3-<region>.onlizard.com`). To attach your own hostname, see [Networking](/networking).
