---
description: "Stream runtime logs, read build logs after a failed deploy, and pull the log tail around a restart, from the CLI or the dashboard."
---
...
- [`lizard logs`](/cli/logs) — the full command reference.
- [Events & History](/observability/events) — deploy history and replica status.
