---
description: "Read a service's deploy timeline and live replica status with lizard events, and find the same history in the dashboard's Deployments view."
---
...
- [`lizard events`](/cli/events) — the full command reference.
