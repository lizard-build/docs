---
description: "Deploy Flowise with PostgreSQL, preserve its credential encryption key, and check saved flows after restarts and upgrades."
---

# Run Flowise with PostgreSQL
