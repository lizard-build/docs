---
description: "Deploy Umami with Managed Postgres, set its encryption secrets, and check analytics after a restart and redeploy."
---

# Run Umami

This guide runs the official Umami Docker image on Lizard with a separate PostgreSQL database. It uses Lizard CLI to deploy a small local Dockerfile and expose Umami over HTTPS.
