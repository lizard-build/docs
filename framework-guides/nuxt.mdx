...
Use the current Lizard CLI from [Prepare the project](/framework-guides#prepare-the-project). Version 0.3.95 excludes macOS archive metadata during uploads. If an older CLI reports a `._*.ts` route error, update the CLI and upload again.
