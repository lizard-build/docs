---
description: "Provision managed Postgres, Redis, and S3-compatible storage with one lizard add command, then wire them into services by reference."
---
...
Scope the reference to the services that actually use it (see [Secret scoping](/variables#scoping)).
