---
description: "Add a managed Redis instance for caching, queues, rate limiting, and pub/sub, and connect it to a service with a single reference."
---
...
- [Background Workers](/deploy/workers) — pairing Redis with a queue-consuming worker.
