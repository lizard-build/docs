...
A **deployment** is one build-and-release of a service. Every deploy produces a build, starts new replicas in fresh pods, and shifts traffic once they're healthy.
