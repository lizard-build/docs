---
description: "Install the lizard CLI, log in, and ship your first app from a GitHub repo or a local folder in a few minutes, then add a database."
---
...
- **[Networking](/networking)** — attach your own hostname with automatic TLS.
- **[Deploying an app your AI IDE built](https://lizard.build/blog/google-antigravity-how-to-deploy-your-app-to-production)** — the same three steps handed to an agent instead, for an app written in Google Antigravity.

## Hosting costs

Lizard uses [pay as you go](/platform/billing) with no monthly subscription. Resource usage draws from your account balance. Purchased credits do not expire; trial credits do. Check [pricing](https://lizard.build/pricing) and your account limits before deploying.
